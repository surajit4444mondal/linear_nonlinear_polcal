...
def get_corrected_data(msname,leakage_file,thetas):
    ...
    print (np.matmul(epsilon_matrix,phi_matrix))
    
    #print (np.matmul(phi_matrix,epsilon_matrix))
...
thetas=[53.09789785*np.pi/180,  6.34591965*np.pi/180,  6.93598442*np.pi/180]
