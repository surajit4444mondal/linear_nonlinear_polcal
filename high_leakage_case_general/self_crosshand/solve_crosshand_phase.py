...
def solve_unitary_matrices(models,observed_stokes):
    res1=minimize(rotate_QUV,[53*np.pi/180,0.1,0.1],args=(observed_stokes,models,\
                    ),method='Nelder-Mead',\
                    bounds=[[-3.14159,3.14159],[-3.14159,3.14159],[-3.14159,3.14159]])
    if res1.success:
        thetas=res1.x
    else:
...
#
#msnames=['polarized_source_I50_Q1_U5_V0.ms','polarized_source_I50_Q15_neg_U5_V0.ms']

#models=[[50,1,5,0],[50,15,-5,0]]
